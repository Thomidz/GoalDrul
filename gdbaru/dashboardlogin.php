...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <nav class="navbar bg-body-tertiary">
        <div class="leaguelinknav">
            <div class="ms-auto">
                <a href="Lpremierleague.php">
                    <img src="assets/premierleague.png" alt="Image 1" class="rounded-circle mx-2" width="40" height="40">
                </a>
                <a href="Llaliga.php">
                    <img src="assets/laliga24.png" alt="Image 2" class="rounded-circle mx-2" width="40" height="40">
                </a>
                <a href="Lligue1.php">
                    <img src="assets/ligue1.png" alt="Image 3" class="rounded-circle mx-2" width="40" height="40">
                </a>
                <a href="Lbundesliga.php">
                    <img src="assets/bundesliga.png" alt="Image 4" class="rounded-circle mx-2" width="40" height="40">
                </a>
                <a href="LserieA.php">
                    <img src="assets/serie_a.png" alt="Image 5" class="rounded-circle mx-2" width="40" height="40">
                </a>
            </div>
        </div>
    </nav>
    ...
    <div class="container mt-5">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://via.placeholder.com/800x400?text=Match+Highlight+1" class="d-block w-100" alt="Match Highlight 1">
            ...
            <div class="carousel-item">
                <img src="https://via.placeholder.com/800x400?text=Match+Highlight+2" class="d-block w-100" alt="Match Highlight 2">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="https://via.placeholder.com/800x400?text=Match+Highlight+3" class="d-block w-100" alt="Match Highlight 3">
                <div class="carousel-caption d-none d-md-block">
